...
usage -auto -elapse
set log file fv/FreqDiv64/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root FreqDiv64 -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/FreqDiv64/g1.v.gz
} else {
...
elaborate design -revised -root FreqDiv64
