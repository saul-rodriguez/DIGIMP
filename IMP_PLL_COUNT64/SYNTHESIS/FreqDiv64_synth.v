...
// Verification Directory fv/FreqDiv64 

module FreqDiv64(Fin, Fsel, Resetn, Fout, F_PFD);
  input Fin, Resetn;
  input [3:0] Fsel;
  output Fout, F_PFD;
  wire Fin, Resetn;
  ...
  MUX2X3_HV g442(.A (n_46), .B (n_45), .S (Fsel[3]), .Q (Fout));
  ...
  IMUX2XL_HV g452(.A (divider[10]), .B (divider[14]), .S (Fsel[2]), .Q
       (n_37));
  IMUX2XL_HV g453(.A (divider[3]), .B (divider[4]), .S (Fsel[0]), .Q
       (n_36));
  IMUX2XL_HV g454(.A (divider[1]), .B (F_PFD), .S (Fsel[2]), .Q (n_35));
  ...
  DFCX3_HV \divider_reg[5] (.RN (Resetn), .CP (Fin), .D (n_10), .Q
       (F_PFD), .QN (UNCONNECTED8));
  HAX3_HV g284(.A (n_7), .B (F_PFD), .CO (n_9), .SUM (n_10));
  DFCX1_HV \divider_reg[4] (.RN (Resetn), .CP (Fin), .D (n_8), .Q
       (divider[4]), .QN (UNCONNECTED9));
  HAX3_HV g286(.A (n_5), .B (divider[4]), .CO (n_7), .SUM (n_8));
