...
#  Created by Encounter(R) RTL Compiler RC14.23 - v14.20-s027_1 on Fri Nov 06 10:37:25 +0100 2015
...
current_design FreqDiv

create_clock -name "Fin" -add -period 25.0 -waveform {0.0 12.5} [get_ports Fin]
set_load -pin_load 0.5 [get_ports Fout]
set_load -pin_load 0.5 [get_ports F_PFD]
