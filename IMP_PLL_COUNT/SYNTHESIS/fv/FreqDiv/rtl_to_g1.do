...
tclmode
set env(RC_VERSION) "RC14.23 - v14.20-s027_1"
vpxmode
set dofile abort exit
usage -auto -elapse
set log file fv/FreqDiv/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root FreqDiv -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/FreqDiv/g1.v.gz
} else {
...
elaborate design -revised -root FreqDiv
