...
usage -auto -elapse
set log file fv/spc2/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/pkg/AMS411/liberty/h18_1.8V/h18_CORELIB_WC.lib
...
elaborate design -golden -root spc2 -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/spc2/g1.v.gz
} else {
...
elaborate design -revised -root spc2
