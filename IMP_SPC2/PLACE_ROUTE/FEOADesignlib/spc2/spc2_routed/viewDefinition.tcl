create_library_set -name libs_typ\
   -timing\
    [list /pkg/AMS411/liberty/h18_1.8V/h18_CORELIB_TYP.lib]
create_library_set -name libs_min\
   -timing\
    [list /pkg/AMS411/liberty/h18_1.8V/h18_CORELIB_BC.lib]
create_library_set -name libs_max\
   -timing\
    [list /pkg/AMS411/liberty/h18_1.8V/h18_CORELIB_WC.lib]
