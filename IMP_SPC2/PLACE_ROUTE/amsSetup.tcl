...
##  version: 24-Apr-2014        
##                              
##  Created on: tis dec 1 11:47:38 CET 2015                          
##                                                    
########################################################
...
proc amsWrite {postfix {dir .}} {
   ...
   saveNetlist $filename_vnl2 -excludeLeafCell -includePhysicalInst \
                         -excludeCellInst { FILLCELLX32 FILLCELLX16 FILLCELLX8 FILLCELLX4 FILLCELLX2 FILLCELLX1 \
                                          }
...
proc amsStat projname {
   ...
   system defStatv2.pl -d $statdir/$topcellname.def \
                       -p $projname \
                       -t h18a6 \
                       /pkg/AMS411/cds/HK_H18/LEF/h18a6/CORELIB.lef \
