...
#  Generated on:      Mon Aug 28 15:16:56 2017
#  Design:            nnspc
#  Command:           floorPlan -site ams018Site -r 0.778846153846 0.696581 17 17 17 17
###############################################################

Version: 8

Head Box: 0.0000 0.0000 98.5600 85.6800
IO Box: 0.0000 0.0000 98.5600 85.6800
Core Box: 20.1600 20.1600 78.4000 65.5200
UseStdUtil: false
...
##############################################################################
DefRow: CORE_ROW_0 ams018Site 20.1600 20.1600 FS 104 1 0.5600 0.0000
DefRow: CORE_ROW_1 ams018Site 20.1600 25.2000 N 104 1 0.5600 0.0000
DefRow: CORE_ROW_2 ams018Site 20.1600 30.2400 FS 104 1 0.5600 0.0000
DefRow: CORE_ROW_3 ams018Site 20.1600 35.2800 N 104 1 0.5600 0.0000
DefRow: CORE_ROW_4 ams018Site 20.1600 40.3200 FS 104 1 0.5600 0.0000
DefRow: CORE_ROW_5 ams018Site 20.1600 45.3600 N 104 1 0.5600 0.0000
DefRow: CORE_ROW_6 ams018Site 20.1600 50.4000 FS 104 1 0.5600 0.0000
DefRow: CORE_ROW_7 ams018Site 20.1600 55.4400 N 104 1 0.5600 0.0000
DefRow: CORE_ROW_8 ams018Site 20.1600 60.4800 FS 104 1 0.5600 0.0000

############################################################################################
#  Track: dir start number space layer_num layer1 [firstColor] [isSameColor] [width] [rule]#
############################################################################################
Track: Y 0.2800 153 0.5600 1 6
Track: X 2.5200 20 5.0400 1 6
Track: X 0.2800 176 0.5600 1 5
Track: Y 0.2800 153 0.5600 1 5
Track: Y 0.2800 153 0.5600 1 4
Track: X 0.2800 176 0.5600 1 4
Track: X 0.2800 176 0.5600 1 3
Track: Y 0.2800 153 0.5600 1 3
Track: Y 0.2800 153 0.5600 1 2
Track: X 0.2800 176 0.5600 1 2
Track: X 0.2800 176 0.5600 1 1
Track: Y 0.2800 153 0.5600 1 1

######################################################
#  GCellGrid: dir start number space                 #
######################################################
GCellGrid: X 95.4800 2 3.0800
GCellGrid: X 0.2800 18 5.6000
GCellGrid: X 0.0000 2 0.2800
GCellGrid: Y 84.2800 2 1.4000
GCellGrid: Y 0.2800 16 5.6000
...
<IOPins>
  <Pin name="Cfg_in" status="placed" >
    <Port>
      <Pref x=0.2800 y=85.6800 side=N width=0.2800 depth=1.1200 orientation=R180 />
      <Layer id=3 >
        <Box llx=0.1400 lly=84.5600 urx=0.4200 ury=85.6800 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="Clk" status="placed" >
    <Port>
      <Pref x=0.8400 y=85.6800 side=N width=0.2800 depth=1.1200 orientation=R180 />
      <Layer id=3 >
        <Box llx=0.7000 lly=84.5600 urx=0.9800 ury=85.6800 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="Resetn" status="placed" >
    <Port>
      <Pref x=1.4000 y=85.6800 side=N width=0.2800 depth=1.1200 orientation=R180 />
      <Layer id=3 >
        <Box llx=1.2600 lly=84.5600 urx=1.5400 ury=85.6800 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="NSEL[4]" >
