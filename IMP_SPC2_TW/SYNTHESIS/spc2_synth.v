...
module spc2(Cfg_in, Clk, Resetn, F, IQ, GS, CE, NS, GD, FS, RE);
  ...
  NOR2XL_HV g96(.A (Clk), .B (n_8), .Q (n_9));
  DFCX1_HV \out_reg[14] (.RN (Resetn), .CP (Clk), .D (out[15]), .Q
       (out[14]), .QN (UNCONNECTED29));
  NAND3X1_HV g98(.A (n_13), .B (n_10), .C (n_12), .Q (n_8));
  DFCX1_HV \out_reg[15] (.RN (Resetn), .CP (Clk), .D (Cfg_in), .Q
       (out[15]), .QN (UNCONNECTED30));
  DFPX3_HV \count_reg[4] (.SN (Resetn), .CP (Clk), .D (n_7), .Q
       (count[4]), .QN (UNCONNECTED31));
  XOR2X1_HV g139(.A (count[4]), .B (n_5), .Q (n_7));
  DFCX1_HV \count_reg[3] (.RN (Resetn), .CP (Clk), .D (n_6), .Q
       (count[3]), .QN (UNCONNECTED32));
  XOR2X1_HV g141(.A (count[3]), .B (n_2), .Q (n_6));
  DFCX1_HV \count_reg[2] (.RN (Resetn), .CP (Clk), .D (n_3), .Q
       (count[2]), .QN (UNCONNECTED33));
  NOR2XL_HV g143(.A (n_4), .B (count[3]), .Q (n_5));
  INVXL_HV g144(.A (n_2), .Q (n_4));
  DFCX1_HV \count_reg[1] (.RN (Resetn), .CP (Clk), .D (n_1), .Q
       (count[1]), .QN (UNCONNECTED34));
  AO21X3_HV g146(.A1 (n_0), .A2 (count[2]), .B1 (n_2), .Q (n_3));
  NOR2XL_HV g147(.A (n_0), .B (count[2]), .Q (n_2));
  XOR2X1_HV g148(.A (count[1]), .B (n_10), .Q (n_1));
  DFCX1_HV \count_reg[0] (.RN (Resetn), .CP (Clk), .D (n_10), .Q
       (count[0]), .QN (n_10));
  OR2X3_HV g150(.A (count[0]), .B (count[1]), .Q (n_0));
endmodule
