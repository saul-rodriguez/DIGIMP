...
#  Generated on:      Tue Aug 29 14:19:03 2017
#  Design:            fet_dec
#  Command:           saveDesign -cellview {fet_dec_OADB fet_dec routed}
###############################################################
...
set_driving_cell -lib_cell NAND2X1 -library ac18_CORELIB_WC -rise -min -pin Q [get_ports {in[4]}]
set_driving_cell -lib_cell NAND2X1 -library ac18_CORELIB_WC -fall -min -pin Q [get_ports {in[4]}]
set_driving_cell -lib_cell NAND2X1 -library ac18_CORELIB_WC -rise -max -pin Q [get_ports {in[4]}]
set_driving_cell -lib_cell NAND2X1 -library ac18_CORELIB_WC -fall -max -pin Q [get_ports {in[4]}]
...
set_load -pin_load -max  0.25  [get_ports {out[31]}]
set_load -pin_load -min  0.25  [get_ports {out[31]}]
set_load -pin_load -max  0.25  [get_ports {out[30]}]
set_load -pin_load -min  0.25  [get_ports {out[30]}]
set_load -pin_load -max  0.25  [get_ports {out[29]}]
set_load -pin_load -min  0.25  [get_ports {out[29]}]
set_load -pin_load -max  0.25  [get_ports {out[28]}]
set_load -pin_load -min  0.25  [get_ports {out[28]}]
set_load -pin_load -max  0.25  [get_ports {out[27]}]
set_load -pin_load -min  0.25  [get_ports {out[27]}]
set_load -pin_load -max  0.25  [get_ports {out[26]}]
set_load -pin_load -min  0.25  [get_ports {out[26]}]
set_load -pin_load -max  0.25  [get_ports {out[25]}]
set_load -pin_load -min  0.25  [get_ports {out[25]}]
set_load -pin_load -max  0.25  [get_ports {out[24]}]
set_load -pin_load -min  0.25  [get_ports {out[24]}]
set_load -pin_load -max  0.25  [get_ports {out[23]}]
set_load -pin_load -min  0.25  [get_ports {out[23]}]
set_load -pin_load -max  0.25  [get_ports {out[22]}]
set_load -pin_load -min  0.25  [get_ports {out[22]}]
set_load -pin_load -max  0.25  [get_ports {out[21]}]
set_load -pin_load -min  0.25  [get_ports {out[21]}]
set_load -pin_load -max  0.25  [get_ports {out[20]}]
set_load -pin_load -min  0.25  [get_ports {out[20]}]
set_load -pin_load -max  0.25  [get_ports {out[19]}]
set_load -pin_load -min  0.25  [get_ports {out[19]}]
set_load -pin_load -max  0.25  [get_ports {out[18]}]
set_load -pin_load -min  0.25  [get_ports {out[18]}]
set_load -pin_load -max  0.25  [get_ports {out[17]}]
set_load -pin_load -min  0.25  [get_ports {out[17]}]
set_load -pin_load -max  0.25  [get_ports {out[16]}]
set_load -pin_load -min  0.25  [get_ports {out[16]}]
...
set_input_delay -add_delay 3 -clock [get_clocks {in[0]}] [get_ports {in[4]}]
...
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[28]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[19]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[26]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[17]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[24]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[31]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[15]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[22]}]
...
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[20]}]
...
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[29]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[27]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[18]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[25]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[16]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[23]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[30]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[14]}]
set_output_delay -add_delay 4 -clock [get_clocks {in[0]}] [get_ports {out[21]}]
