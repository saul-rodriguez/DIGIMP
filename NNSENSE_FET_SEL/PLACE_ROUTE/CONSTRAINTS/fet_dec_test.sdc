...
#  Created by Encounter(R) RTL Compiler RC14.25 - v14.20-s046_1 on Tue Aug 29 11:57:23 +0200 2017
...
set_input_delay -clock [get_clocks {in[0]}] -add_delay 3.0 [get_ports {in[4]}]
...
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[31]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[30]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[29]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[28]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[27]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[26]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[25]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[24]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[23]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[22]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[21]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[20]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[19]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[18]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[17]}]
set_output_delay -clock [get_clocks {in[0]}] -add_delay 4.0 [get_ports {out[16]}]
