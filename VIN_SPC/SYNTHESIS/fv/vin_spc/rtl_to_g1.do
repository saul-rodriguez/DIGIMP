...
usage -auto -elapse
set log file fv/vin_spc/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root vin_spc -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/vin_spc/g1.v.gz
} else {
...
elaborate design -revised -root vin_spc
